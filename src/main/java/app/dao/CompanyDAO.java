...
public interface CompanyDAO extends JpaRepository<Company, java.lang.String> {
   ...
   * @generated
   */
  @Query("SELECT entity.user FROM Department entity WHERE entity.company.id = :id")
   ...
   */
  @Modifying
  @Query("DELETE FROM Department entity WHERE entity.company.id = :instanceId AND entity.user.id = :relationId")
