...
public interface ProductDAO extends JpaRepository<Product, java.lang.String> {
   ...
   * @generated
   */
  @Query("SELECT entity.salesOrder FROM OrderProduct entity WHERE entity.product.id = :id")
  public Page<SalesOrder> listSalesOrder(@Param(value="id") java.lang.String id, Pageable pageable);
   ...
   */
  @Modifying
  @Query("DELETE FROM OrderProduct entity WHERE entity.product.id = :instanceId AND entity.salesOrder.id = :relationId")
  public int deleteSalesOrder(@Param(value="instanceId") java.lang.String instanceId, @Param(value="relationId") java.lang.String relationId);
  /**
   * ManyToOne Relation
   * @generated
   */
  @Query("SELECT entity.budget FROM BudgetProduct entity WHERE entity.product.id = :id")
  public Page<Budget> listBudget(@Param(value="id") java.lang.String id, Pageable pageable);
   ...
   */
  @Modifying
  @Query("DELETE FROM BudgetProduct entity WHERE entity.product.id = :instanceId AND entity.budget.id = :relationId")
  public int deleteBudget(@Param(value="instanceId") java.lang.String instanceId, @Param(value="relationId") java.lang.String relationId);
  /**
   * ManyToOne Relation
   * @generated
   */
